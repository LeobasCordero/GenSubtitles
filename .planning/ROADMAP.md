...
Plans:
- [ ] 999.12-01-PLAN.md — Core translator: Argos batching + DeepL/LibreTranslate engine functions + AppSettings credentials
- [ ] 999.12-02-PLAN.md — CLI --engine flag + pipeline.py forwarding + API engine query param
- [ ] 999.12-03-PLAN.md — GUI engine CTkOptionMenu (show/hide with target lang + disable/enable cycle + wire to API)
- [ ] 999.12-04-PLAN.md — Tests: batching correctness + engine dispatch + error cases
